      ...
      <div className="metrics-grid">
        ...
        <div className="metric-card">
          ...
          <div className="metric-content">
            ...
            <div className="metric-value">{(metrics.candidate_recall * 100).toFixed(2)}%</div>
          </div>
        </div>
        ...
        <div className="metric-card">
          ...
          <div className="metric-content">
            ...
            <div className="metric-value">{(metrics.confirmed_f1_score * 100).toFixed(2)}%</div>
          </div>
        </div>
        ...
        <div className="metric-card">
          ...
          <div className="metric-content">
            ...
            <div className="metric-value">{(metrics.false_positive_precision * 100).toFixed(2)}%</div>
          </div>
        </div>
      </div>
    </div>
